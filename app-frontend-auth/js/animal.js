...
form.onsubmit = function(event) {
  ...
  animal.id_tipo = comboEspecie.selectedIndex + 1;
  animal.id_raca = comboRacas.selectedIndex + 1;
  ...
  if (id_animal == "") enviarAnimal(animal);
  else atualizarDadosAnimal(animal, id_animal);
};
